...
`const home = {
    label: "Home",
    title: "Samet Erkalp's Portfolio",
    description: "Portfolio website showcasing my work as an AI & Data Science Engineer",
    headline: <>From data to decisions</>,
    subline: (
      <>
        I'm Samet — I work at the intersection of AI, data science and bioinformatics,
        <br /> building software solutions for real-world problems.
      </>
    ),
};`,
    language: "tsx",
